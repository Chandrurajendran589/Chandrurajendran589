...
##############################################################################################################################
##
## Script to run the shop sitemap performance test
## The tests can be run multiple times
##
##   Usage: runShopSitemapTest.sh [nsu] [run_count] [sleep_seconds]
##
...
runTest com.wsgc.catalogwebapp.ShopSitemapTest "shopSitemapTest"
