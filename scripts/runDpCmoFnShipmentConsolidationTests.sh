...
##############################################################################################################################
##
## Script to run SPARC Checkout flow for CMO FN Shipment Consolidation performance tests.
##
...
##  At once users test
runTest com.wsgc.dp.checkout.CMOFNShipmentConsolidationTest "CMOFNShipmentConsolidationTest_atOnceUsers-1_Run-${a}" -Ddp.baseUrl='https://www.perf.potterybarnteen.com' -Ddp.testVersion='atOnceUsers' -Ddp.sparc.atOnceUsers=1

## 	Constant Load test
runTest com.wsgc.dp.checkout.CMOFNShipmentConsolidationTest "CMOFNShipmentConsolidationTest_constantUsersPerSec-5-100_Run-${a}" -Ddp.baseUrl='https://www.perf.potterybarnteen.com' -Ddp.testVersion='constantUsersPerSec' -Ddp.sparc.constantUsersPerSec=5 -Ddp.sparc.constantDuration=50 -Ddp.sparc.throttleRps=25 -Ddp.sparc.throttleInDuration=60 -Ddp.sparc.throttleHoldDuration=3600

##  Ramp Users Load Test
runTest com.wsgc.dp.checkout.CMOFNShipmentConsolidationTest "CMOFNShipmentConsolidationTest_rampUsers-20-180_Run-${a}" -Ddp.baseUrl='https://www.perf.potterybarnteen.com' -Ddp.testVersion='rampUsers' -Ddp.sparc.rampUsers=20 -Ddp.sparc.rampDuration=180 -Ddp.sparc.throttleRps=50 -Ddp.sparc.throttleInDuration=60 -Ddp.sparc.throttleHoldDuration=3600
