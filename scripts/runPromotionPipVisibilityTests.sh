...
##
##   Usage: runPromotionPipVisibilityTests.sh [nsu] [run_count] [sleep_seconds]
##
...
for a in `seq 1 ${RUN_COUNT}`; do
  ...
  ##  Promotion Visibility Pip level tests

  runTest com.wsgc.pricing.PromotionPipVisibilityTest "PromotionPipVisibilityTest_5_20_${a}"
