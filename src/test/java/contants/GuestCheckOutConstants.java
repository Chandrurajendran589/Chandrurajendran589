...
public class GuestCheckOutConstants {
    ...
    public static String challangeFlow3DScardNumber = "5520 9050 1002 2044";
    public static String cardSecuritycode = "111";
    public static String cardExpDate = "12/22";
    ...
    public static String TransactionCard = "MASTERCARD ****0011";
    ...
    public static String PleaseAcceptTCtext= "Please accept our Privacy Policy and Terms and Conditions before you continue with fuelling!";
    ...
    public static String LocateYourStation= "Let us locate\nyour current\nstation";
    ...
    public static String Pump_Selection_Message= "Make sure you are parked at this\npump and remain in your vehicle.";
    public static String Pump_Number= "1";
    public static String Maximum_FuelAmount= "Your Maximum Fuelling Amount: £100";
    ...
    public static String Ready_ToStart_Fuelling= "Ready to \nstart fuelling?";
    ...
    public static String SendReceiptEmail="mahadev.h@photon.in";
    ...
    public static String CANCEL= "CANCEL";
    public static String SetupApplePayOrCardText="Please Setup Apple Pay or manually add a Debit/Credit card to pay with the Esso App";
    ...
    public static String ConfirmPaymentSubHeader="The fuel price displayed on the pump will apply.";
