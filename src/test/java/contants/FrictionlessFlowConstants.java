...
public class FrictionlessFlowConstants {
	...
	public static String CardNumber = "****0006";
	...
	public static String Adddebitbtn = "CONTINUE";
    ...
    public static String LinkTxxt = "I consent to use the card for purchases in the Esso App";
	public static String CARDNUMBER = "4006 3400 0000 0014";
	...
	public static String RESENDPOPUPMSG = "We have sent you instructions to reset your password. Please check your inbox or spam folder.\n";
	public static String RESENDPOPUPTITLE = "Email Sent";
